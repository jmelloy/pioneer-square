...
Identical to backend/foreman/prompt.py — kept in sync by hand.  The standalone
foreman imports this module instead of the backend package so it has no backend
