...
def _message_dict(m: Message) -> dict:
    ...
    # Expose the task this message concerns under the same camelCase key the live
    ...
    # so a task-scoped Foreman line loaded from history would otherwise render
    # without its task badge.
