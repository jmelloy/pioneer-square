...
def test_format_stream_entries_omits_tool_result_output():
    """Tool output is omitted entirely, not shown as a preview (issue #1107) —
...
def test_format_stream_entries_zero_tool_calls_passes_through():
    """A run of only tool_result entries (no tool_use) is omitted entirely."""
