...
- Call create_task(name="Review PR #N: <title>", phase="review") immediately before calling review_pr_internal or review_pr; retain the returned task_id for finalize_task; call finalize_task on that task_id after the review completes (success or failure)
